...
rggm.L["changemenu_to_foreground"] = "Bring change menu to the foreground"
rggm.L["changemenu_to_foreground_tooltip"] = "Shows the change menu for example over the actionbar"

...
rggm.L["changemenu_to_foreground"] = "Bring Changemenu to the foreground"
rggm.L["changemenu_to_foreground_tooltip"] = "Shows the Changemenu for example over the actionbar"

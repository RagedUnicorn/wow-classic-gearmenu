...
if (GetLocale() == "zhCN") then
  ...
  -- options
  rggm.L["options_category_name"] = "选项"
  rggm.L["options_title"] = "选项"
  ...
  rggm.L["profile_create_button"] = "创建新配置文件"
  rggm.L["profile_load_button"] = "加载"
  rggm.L["profile_rename_button"] = "重命名"
  rggm.L["profile_delete_button"] = "删除"
  rggm.L["profile_reset_button"] = "恢复默认设置"
  ...
  rggm.L["profile_active_suffix"] = "%s(当前)"
  rggm.L["profile_load_confirm"] = "加载配置文件\"%s\"?你当前的设置将保留在\"%s\"中,然后重新加载界面。"
  rggm.L["profile_delete_confirm"] = "删除配置文件\"%s\"?"
  rggm.L["profile_delete_active_confirm"] = "删除配置文件\"%s\"?它是当前配置文件 - \"%s\"将接管你的设置,然后重新加载界面。"
  rggm.L["profile_reset_confirm"] = "将配置文件\"%s\"恢复为出厂设置?|n|n每个选项都将恢复为默认值,"
    .. "你的GearBar和QuickChange规则将被初始GearBar替换,然后重新加载界面。"
  rggm.L["profile_create_success"] = "已创建配置文件\"%s\" - 它现在是当前配置文件"
  ...
  rggm.L["profile_error_default_cannot_be_overwritten"] = "“%s”是保留的配置文件名称"
end

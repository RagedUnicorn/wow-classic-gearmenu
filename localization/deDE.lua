...
if (GetLocale() == "deDE") then
  ...
  rggm.L["enable_weapon_flyout"] = "Schneller Waffenwechsel"
  rggm.L["enable_weapon_flyout_tooltip"] = "Experimentell. Waffenslots öffnen ein Menü mit"
    .. " vorbereiteten Makros, das auch im Kampf funktioniert"
  rggm.L["weapon_flyout_unequip_in_combat"] = "Ablegen ist im Kampf nicht möglich"

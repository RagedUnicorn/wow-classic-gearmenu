...
if (GetLocale() == "deDE") then
  ...
  rggm.L["profile_create_button"] = "Neues Profil erstellen"
  rggm.L["profile_load_button"] = "Laden"
  rggm.L["profile_rename_button"] = "Umbenennen"
  rggm.L["profile_delete_button"] = "Löschen"
  rggm.L["profile_reset_button"] = "Auf Standard zurücksetzen"
  ...
  rggm.L["profile_active_suffix"] = "%s (aktiv)"
  rggm.L["profile_load_confirm"] = "Profil \"%s\" laden? Deine aktuellen Einstellungen bleiben in \"%s\" "
    .. "gespeichert, danach wird die Benutzeroberfläche neu geladen."
  rggm.L["profile_delete_confirm"] = "Profil \"%s\" löschen?"
  rggm.L["profile_delete_active_confirm"] = "Profil \"%s\" löschen? Es ist das aktive Profil - \"%s\" übernimmt "
    .. "deine Einstellungen, danach wird die Benutzeroberfläche neu geladen."
  rggm.L["profile_reset_confirm"] = "Profil \"%s\" auf die Werkseinstellungen zurücksetzen?|n|nJede Option geht "
    .. "auf ihren Standardwert zurück und deine GearBars und QuickChange-Regeln werden durch die Start-GearBar "
    .. "ersetzt, danach wird die Benutzeroberfläche neu geladen."
  rggm.L["profile_create_success"] = "Profil \"%s\" erstellt - es ist jetzt aktiv"
  ...
  rggm.L["profile_error_default_cannot_be_overwritten"] = "\"%s\" ist ein reservierter Profilname"
end

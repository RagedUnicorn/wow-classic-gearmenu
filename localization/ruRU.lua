...
if (GetLocale() == "ruRU") then
  ...
  rggm.L["enable_weapon_flyout"] = "Быстрая смена оружия"
  rggm.L["enable_weapon_flyout_tooltip"] = "Экспериментально. Слоты оружия открывают меню с"
    .. " готовыми макросами, которое работает и в бою"
  rggm.L["weapon_flyout_unequip_in_combat"] = "Снять предмет во время боя нельзя"

...
if (GetLocale() == "ruRU") then
  ...
  rggm.L["gear_bar_move_combat"] =
    "Невозможно переместить панель экипировки в бою. Пожалуйста, попробуйте после боя"
  rggm.L["gear_slot_size_combat"] =
    "Невозможно изменить размер слотов экипировки в бою. Пожалуйста, попробуйте после боя"
  ...
  rggm.L["profile_create_button"] = "Создать новый профиль"
  rggm.L["profile_load_button"] = "Загрузить"
  rggm.L["profile_rename_button"] = "Переименовать"
  rggm.L["profile_delete_button"] = "Удалить"
  rggm.L["profile_reset_button"] = "Сбросить по умолчанию"
  ...
  rggm.L["profile_active_suffix"] = "%s (активный)"
  rggm.L["profile_load_confirm"] = "Загрузить профиль \"%s\"? Ваши текущие настройки останутся сохранёнными "
    .. "в \"%s\", затем интерфейс перезагрузится."
  rggm.L["profile_delete_confirm"] = "Удалить профиль \"%s\"?"
  rggm.L["profile_delete_active_confirm"] = "Удалить профиль \"%s\"? Это активный профиль - \"%s\" примет ваши "
    .. "настройки, затем интерфейс перезагрузится."
  rggm.L["profile_reset_confirm"] = "Сбросить профиль \"%s\" к заводским настройкам?|n|nКаждая опция вернётся "
    .. "к значению по умолчанию, а ваши панели GearBar и правила QuickChange будут заменены стартовой "
    .. "панелью GearBar, затем интерфейс перезагрузится."
  rggm.L["profile_create_success"] = "Профиль \"%s\" создан - теперь он активен"
  ...
  rggm.L["profile_error_default_cannot_be_overwritten"] = "\"%s\" - зарезервированное имя профиля"
end
